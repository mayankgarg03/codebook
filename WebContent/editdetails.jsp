...
<body>
		...
		<%UserDAO userdao = new UserDAO(); 
			SignupDTO signupdto = 	userdao.getUser((String)session.getAttribute("email"));%>
    ...
    <%--   <%
      ...
      <label>First name:</label>
        <input value="<%=signupdto.getFirstname() %>" type="text" name="firstName" class="form-control " placeholder="First name" required="required">
        </div>
        <div class="from-group">
         <label>Last name:</label>
        <input value="<%=signupdto.getLastname() %>" type="text" name="lastName" class="form-control " placeholder="Last name" required="required">
        </div>
        
       <%--  <div class="form-group">
        <label>Email</label>
        <input value="<%=signupdto.getEmail()%>" type="email" name="email" readonly="readonly" class="form-control " placeholder="Email" required="required">
        </div> --%>
        <%-- <div class="form-group">
        ...
        <div class="form-inline">
            ...
            <br>
           <label>Gender</label>
                <input value="Female"  name="gender" type="radio" id="fem" class="m0">
                <label for="fem" class="gender">Female
                </label>
                <input value="Male"  name="gender" type="radio" id="male" class="m0">
